...
<head>
    ...
    <style>
        ...
        .header {
            display: grid;
             space-between; /*  ロゴが左端、ボタンが右端 */
            grid-template-columns: 1fr auto 1fr; /*  画面を「左・中央・右」の3つに等しく分けます */
            align-items: center;            /*  上下の高さを中央で揃えます */
            padding: 30px 40px;                  /* 上下のゆとりを持たせます */
            solid #e0e0e0;
        ...
        .btn-auth-switch {
            background-color: #d1c7bd;      /* 上品なベージュ */
            color: #ffffff !important;      /* 文字色は白 */
            text-decoration: none;          /* 下線を消す */
            padding: 6px 16px;              /* ボタンのぷっくり感 */
            border-radius: 5px;             /* ほんのり丸み */
            font-size: 13px;                /* 小さめで主張しすぎないサイズ */
            font-weight: normal;
            transition: background-color 0.2s;
        }
    </style>
...
<body>
    ...
    <div class="header">
        ...
        <a href="/login" class="btn-auth-switch">login</a>
    </div>
